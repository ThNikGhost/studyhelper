...
## Описание
**StudyHelper** — персональное PWA для студентов ОмГУ: расписание (автопарсинг), дедлайны, файлы, инфо о преподавателях и группе. Парный режим (2 пользователя).
...
- Парный режим: 2 пользователя видят все данные, WorkStatus per user
