...
down_revision: str | Sequence[str] | None = "1f580bc1b2b5"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_lk_credentials_user_id"), "lk_credentials", ["user_id"], unique=True
    )
    ...
    op.create_index(
        op.f("ix_session_grades_user_id"), "session_grades", ["user_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_semester_disciplines_user_id"),
        "semester_disciplines",
        ["user_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_semester_disciplines_user_id"), table_name="semester_disciplines"
    )
