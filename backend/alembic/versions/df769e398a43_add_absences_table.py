...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('user_id', 'schedule_entry_id', name='uq_absence_user_entry')
    )
    op.create_index('ix_absences_schedule_entry_id', 'absences', ['schedule_entry_id'], unique=False)
