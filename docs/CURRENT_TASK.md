...
Последний коммит `caccbce` (2026-02-18): fix — горизонтальный скролл сетки расписания до субботы/воскресенья на мобильных (объединение двух конфликтующих scroll-контейнеров в один).
