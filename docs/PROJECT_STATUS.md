...
- **Дата**: 2026-02-09
- **Сессия**: Production Deployment Completed
...
11. **SSL (HTTPS)** — Let's Encrypt (P0, требует доменное имя)
12. **Бэкапы PostgreSQL** — cron + pg_dump (P0)
13. **05-ics-export** — экспорт в .ics (P2)
14. **02-push-notifications** — push-уведомления (P1, зависит от PWA ✅)
