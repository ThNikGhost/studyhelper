...
- **Дата**: 2026-02-05
- **Сессия**: Улучшения SchedulePage + SemestersPage

## Общий прогресс
**Фаза**: MVP разработка
**Прогресс**: ~90% (backend готов + парсер + все страницы кроме ClassmatesPage)
...
- [ ] ClassmatesPage — в плане

---

## Что в работе

### Текущая задача: Frontend страницы MVP
...
| Frontend страниц | 7 (Login, Register, Dashboard, Schedule, Subjects, Works, Semesters) |
