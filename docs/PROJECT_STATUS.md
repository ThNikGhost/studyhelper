...
- **Дата**: 2026-02-04
- **Сессия**: Создание SubjectsPage frontend

## Общий прогресс
**Фаза**: MVP разработка
**Прогресс**: ~85% (backend готов + парсер + SchedulePage + SubjectsPage)
...
- [x] Страница предметов (SubjectsPage) ✅ — создана, но не закоммичена
...
### Текущая задача: Frontend страницы
SubjectsPage создана, нужно:
1. Проверить сборку frontend (npm run build)
2. Закоммитить изменения
3. Создать WorksPage

### Следующие задачи:
- WorksPage — страница работ (дедлайны, статусы)
...
| Frontend страниц | 5 (Login, Register, Dashboard, Schedule, Subjects) |
